...
class BikesNearYouAdapter(private val placeList: List<Place>, private val locImage: List<Int>) : RecyclerView.Adapter<BikesNearYouAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClickCallback.onItemClicked(placeList[holder.adapterPosition], locImage[holder.adapterPosition])
        }
    }
